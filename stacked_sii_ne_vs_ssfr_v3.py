...
out_csv = os.path.join(current_dir, "results/csv/stacked_sii_ratio_vs_ssfr_COMPLETE_v3.csv")
out_png = os.path.join(current_dir, "results/figure/stacked_sii_ratio_vs_ssfr_COMPLETE_v3.png")
