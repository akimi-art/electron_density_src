...
data = [[0.275, 0.000, 0.222, 0.005, 0.075, 0.053],
        ...
        [0.276, 0.000, 0.230, 0.004, 0.006, 0.044],
        [0.017, 0.880, 0.230, 0.000, 0.367, 0.019],
        [0.212, 0.381, 0.230, 0.000, 0.803, 0.050],
        [0.000, 1.000, 0.230, 0.000, 1.043, 0.128],
        [-0.480, 0.000, -0.081, 0.016, 2.747, 0.136]]

columns = ["tau", "p-value", "slope", "slope_err", "intercept", "intercept_err"]
index = ["SDSS_only(no AGN)", "CLASSY_only", "SDSS_x<10", "SDSS_x>10.5",
         "z~0", "z~3", "z~6", "z~9",
         "z~3 (a=0.222)", "z~6 (a=0.222)", "z~9 (a=0.222)",
         "SDSS_only", "z~3 (a=0.230)", "z~6 (a=0.230)", "z~9 (a=0.230)",
         "stacked"]
