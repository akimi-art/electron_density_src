...
使用方法:
    ne_vs_sm_kendall_slope_fixed.py [オプション]
...
Samir16out    = os.path.join(current_dir, "results/Samir16/Samir16out_standard_v3_ms_only_v3_direct_Te_no_agn.py")
...
# === inputファイルから情報を抜き出す ===
Samir16in     = os.path.join(current_dir, "results/Samir16/Samir16in_standard_v3_ms_only_v3_direct_Te_no_agn.txt")
...
# ============================================================
x_data = np.array(metal_list)            # log10(M*)
y_data = np.array(ne_list)            # log10(ne)
xerr_data = np.array(metal_xerr_list)    # dex
...
# --- 固定する傾き ---
# ============================================================
a_fixed = -0.162   # ← 任意に設定（例：z~0 サンプル）
