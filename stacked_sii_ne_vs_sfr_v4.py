...
使用方法:
    stacked_sii_ne_vs_sfr_v4.py [オプション]
...
out_csv = os.path.join(current_dir, "results/csv/stacked_sii_ratio_vs_sfr_COMPLETE_v4.csv")
out_png = os.path.join(current_dir, "results/figure/stacked_sii_ratio_vs_sfr_COMPLETE_v4.png")
...
# 高zサブサンプル
m_complete_highz = m_complete & m_z_high
